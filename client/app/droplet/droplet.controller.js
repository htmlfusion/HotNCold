...
angular.module('angularPrototypeApp')
  .controller('DropletCtrl', function($scope, $cordovaGeolocation) {
    ...
    var wave = function(){
      setTimeout(function(){
        dropletPosition += 1;
        $('#wave').css('background-position-y', '{}px'.replace('{}', dropletPosition));
        $('#wave').css('transform', 'rotate({}deg)'.replace('{}', bearing));
        wave();
      }, 30);
    }
    wave();
